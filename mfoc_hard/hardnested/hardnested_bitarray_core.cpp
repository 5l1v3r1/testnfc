...
#define __BIGGEST_ALIGNMENT__ __builtin_alignof(x))
...
//#if defined (_WIN32)
//    return  __builtin_assume_aligned(_aligned_malloc((x), __builtin_alignof(x)), __builtin_alignof(x)));
...
//inline void BITARRAY_LOW20_AND(uint32_t * __declspec(restrict)A, uint32_t * __declspec(restrict)B) {
...
//}
//
//inline uint32_t COUNT_BITARRAY_AND(uint32_t * __declspec(restrict)A, uint32_t * __declspec(restrict)B) {
//    A = __builtin_assume_aligned(A, __BIGGEST_ALIGNMENT__);
//    B = __builtin_assume_aligned(B, __BIGGEST_ALIGNMENT__);
//    uint32_t count = 0;
//    for (uint32_t i = 0; i < (1 << 19); i++) {
...
//}
//
//inline uint32_t COUNT_BITARRAY_LOW20_AND(uint32_t * __declspec(restrict)A, uint32_t * __declspec(restrict)B) {
//    uint16_t *a = (uint16_t *) __builtin_assume_aligned(A, __BIGGEST_ALIGNMENT__);
//    uint16_t *b = (uint16_t *) __builtin_assume_aligned(B, __BIGGEST_ALIGNMENT__);
//    uint32_t count = 0;
//
...
//
//inline uint32_t COUNT_BITARRAY_AND2(uint32_t * __declspec(restrict)A, uint32_t * __declspec(restrict)B) {
//    A = __builtin_assume_aligned(A, __BIGGEST_ALIGNMENT__);
//    B = __builtin_assume_aligned(B, __BIGGEST_ALIGNMENT__);
//    uint32_t count = 0;
//    for (uint32_t i = 0; i < (1 << 19); i++) {
...
//}
//
//inline uint32_t COUNT_BITARRAY_AND3(uint32_t * __declspec(restrict)A, uint32_t * __declspec(restrict)B, uint32_t * __declspec(restrict)C) {
//    A = __builtin_assume_aligned(A, __BIGGEST_ALIGNMENT__);
//    B = __builtin_assume_aligned(B, __BIGGEST_ALIGNMENT__);
//    C = __builtin_assume_aligned(C, __BIGGEST_ALIGNMENT__);
//    uint32_t count = 0;
...
//}
//
//inline uint32_t COUNT_BITARRAY_AND4(uint32_t * __declspec(restrict)A, uint32_t * __declspec(restrict)B, uint32_t * __declspec(restrict)C, uint32_t * __declspec(restrict)D) {
//    A = __builtin_assume_aligned(A, __BIGGEST_ALIGNMENT__);
//    B = __builtin_assume_aligned(B, __BIGGEST_ALIGNMENT__);
//    C = __builtin_assume_aligned(C, __BIGGEST_ALIGNMENT__);
//    D = __builtin_assume_aligned(D, __BIGGEST_ALIGNMENT__);
